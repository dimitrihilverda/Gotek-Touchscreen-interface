...
// ============================================================================
// HTTP Utilities (shared)
// ============================================================================

#include "../shared/http_utils.h"

// Alias for local code that still calls parseHttpRequest
inline bool parseHttpRequest(WiFiClient &client, HttpRequest &req) {
  return parseRequest(client, req);
}
